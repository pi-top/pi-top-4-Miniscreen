...
class InfoPage(Component):
    def __init__(
        ...
        **kwargs
        ...
        self.list = self.create_child(List, Rows=Rows, row_gap=3)
    ...
    def render(self, image):
        ...
        list_size = (
            image.width - list_horizontal_padding * 2 + 1,
