...
from pt_miniscreen.core.hotspots.page_list import PageList
...
class MenuPage(Hotspot):
    def __init__(
        ...
        **kwargs,
        ...
        self.PageList = partial(PageList, Pages=Pages)
        self.cover_image_size = image_size
        self.cover_image = self.create_hotspot(Image, image_path=image_path)
        self.title = self.create_hotspot(Text, text=text, font_size=font_size)
